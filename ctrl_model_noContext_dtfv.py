...
from dataset_noContext_dtfv import TestingDataSet
from dataset_noContext_dtfv import TrainingDataSet
...
class CTRL_Model(object):
    def __init__(self, batch_size, train_csv_path, test_csv_path, test_visual_feature_dir, train_visual_feature_dir):
        ...
        self.semantic_size = 3072 #3072  # 2048  # 2048 # the size of visual and semantic comparison size
