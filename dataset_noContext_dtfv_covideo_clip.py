...
class TrainingDataSet(object):
    def __init__(self, sliding_dir, it_path, batch_size):
        ...
        self.visual_feature_dim = 21800  # 43600  # 21800
                    ...
                    if original_movie_name==movie_name:
                        ...
                        if iou>0.5:
                            ...
                            if nIoL<0.15:
                                ...
                                #f.write(clip_name+'\n')
                                #copyfile('/home/ethan/IJCAI18/dtfv_feature/script/clip_features/' + clip_name,
                                #         '/home/ethan/IJCAI18/dtfv_feature/script/clip_features_small/'+clip_name)
        #f.close()
        self.num_samples_iou = len(self.clip_sentence_pairs_iou)
        print(str(len(self.clip_sentence_pairs_iou))+" iou clip-sentence pairs are readed")
